with open(r'C:/Users/Feng/Desktop/AgentItemDev/reedit_standard.txt', 'r', encoding='utf-8') as file:
    # Read the contents of the file
    fixPrompt_content = file.read()
with open(r'C:/Users/Feng/Desktop/AgentItemDev/temp_postrevisionNeeded.txt ', 'r', encoding='utf-8') as file:
    # Read the contents of the file
