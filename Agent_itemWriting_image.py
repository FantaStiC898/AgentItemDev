with open(r'C:/Users/Feng/Desktop/AgentItemDev/start_writing_image.txt', 'r', encoding='utf-8') as file:
    # Read the contents of the file
    fixPrompt_content = file.read()
with open(r'C:/Users/Feng/Desktop/AgentItemDev/temp_itemNeeded.txt ', 'r', encoding='utf-8') as file:
    # Read the contents of the file
