with open(r'C:/Users/Feng/Desktop/AgentItemDev/revise_initial.txt', 'r', encoding='utf-8') as file:
    # Read the contents of the file
    fixPrompt_content = file.read()

with open(r'C:/Users/Feng/Desktop/AgentItemDev/temp_commentNeeded.txt ', 'r', encoding='utf-8') as file:
    # Read the contents of the file
